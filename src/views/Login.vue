<template>
  <div class="login">
      ...
      <el-row :gutter='10'>
        ...
        <el-col :span="12">
          <div class="grid-content bg-purple-light">
            <el-button style='background-color:#008BD7;border:none' type="primary" @click="clickLoad">选择私钥文件</el-button>
            <input type="file" id="files" ref="refFile" style="display: none" @change="fileLoad">
          </div>
          </el-col>
      </el-row>
      <p style='color:gray;font-size:14px;text-align:left;margin-bottom:5px'><i class="el-icon-warning-outline"></i>私钥只留存本地，不会上传到任何服务器</p>
      <br><br>
      <el-input
    ...
    <div class="submit">
      <el-button @click="getLogin" style='width:80%;background-color:#008BD7;border:none' type="primary" round>登录</el-button>
    </div>
  </div>
</template>
